...
public class PutLogoutTest {
	...
	public static void setUpBeforeClass() throws Exception {
		DEVICE_ID = (new com.lge.stark.httphandler.device.PostTest()).registedDeviceId();

		(new com.lge.stark.httphandler.device.PostTest()).regist(DEVICE_ID2);

		USER_ID = (new com.lge.stark.httphandler.user.PutLoginTest()).loginedUserId(DEVICE_ID);
	}

	@AfterClass
	public static void tearDownAfterClass() throws Exception {
		if (DEVICE_ID != null) {
			(new com.lge.stark.httphandler.device.DeleteTest()).delete(DEVICE_ID);
		}
		if (DEVICE_ID2 != null) {
			(new com.lge.stark.httphandler.device.DeleteTest()).delete(DEVICE_ID2);
		}
	}
